...
5. Add as GitHub secret: GOOGLE_CREDENTIALS
6. Create a Drive folder for outputs
7. Share that folder with the service account email (xxx@xxx.iam.gserviceaccount.com)
8. Copy the folder ID from the URL and add as secret: DRIVE_FOLDER_ID
"""
...
def main():
    ...
    # Save file IDs for Discord notification
